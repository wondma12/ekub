...
const Draws = () => {
  ...
  const getStatusBadge = (status) => {
    const badges = {
      ረቂቅ: 'bg-yellow-100 text-yellow-800',
      ዝግጁ: 'bg-blue-100 text-blue-800',
      በሂደትላይ: 'bg-green-100 text-green-800',
      ተጠናቋል: 'bg-gray-100 text-gray-800',
      ተሰርዟል: 'bg-red-100 text-red-800',
    };
